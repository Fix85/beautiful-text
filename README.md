...
> This branch (`mc-1.17.1`) targets **Minecraft 1.17.1**.
> For Minecraft 1.21.4 see [`mc-1.21.4`](https://github.com/Fix85/beautiful-text/tree/mc-1.21.4).
...
Fabric API is **not required** — Cloth Config is bundled into the jar.

### Installation

1. Install Fabric Loader `0.14.0+` for Minecraft `1.17.1`.
...
> Эта ветка (`mc-1.17.1`) собрана под **Minecraft 1.17.1**.
> Версия для Minecraft 1.21.4 — в ветке [`mc-1.21.4`](https://github.com/Fix85/beautiful-text/tree/mc-1.21.4).
...
Fabric API **не нужен** — Cloth Config встроен в jar.

### Установка

1. Установи Fabric Loader `0.14.0+` для Minecraft `1.17.1`.
